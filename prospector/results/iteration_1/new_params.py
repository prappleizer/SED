...
run_params = {'verbose':True,
              'debug':False,
              'outfile':'../results/iteration_1/TRY2',                    #### SET OUTPUT DIR/FILE ####
              # Fitter parameters
              ...
              'initial_disp':0.1,
              # Obs data parameter
      	      'phottable':'../../SEDs/v2/seds/iteration1_sed.txt',        #### SET INPUT SED (CHANGE NUM) ####
              'objname':'iteration1',                                     #### SET OBJNAME ####               
              'filt_dir':'../../SEDs/v2/composite_filters/iteration_1/',   #### SET INPUT FILTER DIRECTORY ####
...
def load_obs(objname='objname', phottable='phottable',filt_dir='filt_dir', **kwargs):
    ...
    obs['maggies_unc'][0:-3] = .05*fl_maggies[0:-3] #### THIS THING INVOLVES A LOT OF TOYING WITH
