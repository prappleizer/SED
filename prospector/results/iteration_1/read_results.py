...
filename = raw_input('Enter MCMC filename: ')
if os.path.exists('/Users/ipasha/RESEARCH/CSED_2017/prospector/results/iteration_1/run_params.py'):
	os.system('rm /Users/ipasha/RESEARCH/CSED_2017/prospector/results/iteration_1/run_params.py')
	os.system('cp /Users/ipasha/RESEARCH/CSED_2017/prospector/code/new_params.py .')
else:
	os.system('cp /Users/ipasha/RESEARCH/CSED_2017/prospector/code/new_params.py .')
	
res, _, mod = bread.results_from(filename)
print 'functions: walkers(), plot_sed()' 
