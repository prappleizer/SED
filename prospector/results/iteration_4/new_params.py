...
run_params = {'verbose':True,
              'debug':False,
              'outfile':'../results/iteration_4/TRY1',                    #### SET OUTPUT DIR/FILE ####
              # Fitter parameters
              ...
              'initial_disp':0.1,
              # Obs data parameter
      	      'phottable':'../../SEDs/v3/seds/iteration4_sed.txt',        #### SET INPUT SED (CHANGE NUM) ####
              'objname':'iteration4',                                     #### SET OBJNAME ####               
              'filt_dir':'../../SEDs/v3/composite_filters/iteration_4/',   #### SET INPUT FILTER DIRECTORY ####
...
def load_obs(objname='objname', phottable='phottable',filt_dir='filt_dir', **kwargs):
    ...
    obs['maggies_unc'][0:-4] = .05*fl_maggies[0:-4] #### THIS THING INVOLVES A LOT OF TOYING WITH
